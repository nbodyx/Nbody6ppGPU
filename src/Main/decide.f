      SUBROUTINE DECIDE(IPAIR,SEMI,ECC,EMAX,EMIN,TG,EDAV,IQ)
*
*
*       Merger decision.
*       ----------------
...
*       Evaluate t_{circ} and (de/dt)_{circ} except for near-collision.
          ...
          IF (PMIN.GT.RM) THEN
              ...
              CALL TCIRC(PMIN,ECC,I1,I2,ICIRC,TC1)
*             CALL EDOT(IPAIR,JCOMP,SEMI,ECC,ECCDOT)
              CALL ECIRC(PMIN,ECC,I1,I2,TG,TC2,ECC2,EDT)
...
*       Produce diagnostic output for large eccentricity.
   ...
   20         FORMAT ('DECIDE:  NAME(I1) Time[NB] ECC0 ECC1 ECCMIN ',
     &             'ECCMAX ECCD[1/Myr] EDT[NB] TG[Myr] TC[Myr] ',
     &             'EDAV[1/Myr] PERIM[RSM]',
     &             I12,1P,E19.10,0P,4F10.5,1P,6E15.6)
              CALL FLUSH(75)
          END IF
      ELSE
          DT1 = 10.0/TSTAR
