...
*
          ...
          A(18) = 6.0*A(15)
          A(19) = 9.0*A(15)
          A(20) = (A(4)*A(4) + A(5)*A(5) + A(6)*A(6) + A(1)*A(7) +
     &         A(2)*A(8) + A(3)*A(9))*A(13) + A(16)
          A(21) = 9.0*A(20)
          A(20) = 3.0*A(20)
          A(22) = (9.0*(A(4)*A(7) + A(5)*A(8) + A(6)*A(9)) +
     &         3.0*(A(1)*A(10) + A(2)*A(11) + A(3)*A(12)))*A(13) +
     &         A(17)*(A(20) - 4.0*A(16))
*
          DO 50 K = 1,3
              F1DOTK = A(K+3) - A(17)*A(K)
              F2DOT(K) = (A(K+6) - A(18)*F1DOTK - A(20)*A(K))*A(14)
              F3DOT(K) = (A(K+9) - A(21)*F1DOTK - A(22)*A(K))*A(14) -
     &             A(19)*F2DOT(K)
   50     CONTINUE
*
