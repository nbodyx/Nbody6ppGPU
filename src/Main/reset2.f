   ...
   42     CONTINUE
          IF (RIJ2.LT.RS2.AND.J.NE.JCOMP1.AND.J.LE.N) THEN
              ...
              DO 45 K = 1,3
                  ...
                  X0(K,J) = X(K,J)
   45         CONTINUE
*     Remove old J from NXTLST
              call delay_remove_tlist(J,STEP,DTK)
              CALL FPOLY1(J,J,0)
              CALL FPOLY2(J,J,0)
*     Add new J into NLSTDELAY
