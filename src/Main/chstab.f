...
*       Check hierarchical stability condition for bound close pair (RB > a).
   ...
   20     FORMAT (' NEW HIARCH    NAMEM(I1) ',I11,'  NAMEM(I2) ',I11,
     &         '  NAMEM(I3) ',I11,'  ECC0 ',F10.5,'  ECCMAX ',F10.5,
     &         '  ECC1 ',F10.5,'  SEMI0[NB] ',1P,E15.6,
     &         '  SEMI1[NB] ',E15.6,'  PERIM[NB] ',E15.6,
     &         '  PCR[NB] ',E15.6,'  INA[deg] ',0P,F7.1)
          RI = SQRT(CM(1)**2 + CM(2)**2 + CM(3)**2)
          Q0 = M(I3)/MB
          if(rank.eq.0)
     &    WRITE (81,30)  TIMEC, RI, NAMEC(I3), Q0, ECC, EMAX, ECC1,
     &                   SEMI, SEMI1, PCRIT/PMIN, ALPHA
   30     FORMAT ('CHSTAB:  TIMEC RI[NB] NAME(I3) M(I3)/M(INCM) ECC0 ',
     &         'ECCMAX ECC1 SEMI0[NB] SEMI1[NB] PCR/PERIM INA[deg] ',
     &         1P,E15.6,0P,F5.1,I12,F6.2,3F6.3,1P,2E10.2,0P,
     &         F5.2,F8.1)
          CALL FLUSH(81)
          END IF
