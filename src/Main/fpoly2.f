...
*
*
      if(time.gt.0) CALL xbpredall
*     --03/01/14 19:25-lwang-debug--------------------------------------*
***** Note:------------------------------------------------------------**
c$$$      if(time.ge.0.7307) then
c$$$         do I = ifirst,Ntot
c$$$            write(105+rank,*) 'i',i,'n',name(i),'x',x(1,i),
c$$$     &           'xd',xdot(1,i),'f',f(1,i),'fdot',fdot(1,i),
c$$$     &           'step',step(i),'t0',t0(i),'t',time
c$$$         end do
c$$$         call flush(105+rank)
c$$$      end if
*     --03/01/14 19:25-lwang-end----------------------------------------*
