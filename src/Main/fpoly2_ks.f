      SUBROUTINE FPOLY2_KS(I1,I2,KCASE)
*
*
...
*
   ...
   45     CONTINUE
*     --03/04/14 21:21-lwang-debug--------------------------------------*
***** Note:------------------------------------------------------------**
c$$$          if(time.ge.32.528516769409180) then
c$$$             write(102+rank,*) 'n',name(i),'j',j,'xd',x0dot(1,j)
c$$$     &            ,'xid',xdot(1,i),'x',x0(1,j),'xi',x(1,i),'t',time
c$$$             call flush(102+rank)
c$$$          end if
*     --03/04/14 21:21-lwang-end----------------------------------------*
*
          A13 = 1.0/RIJ2
