...
*
      INCLUDE 'common6.h'
*     safe for parallel, no value change, used value: ich
...
*****     In jpred, unpert ks will not be resolved
          J1 = 2*J - 1
          IF(LIST(1,J1).EQ.0) CALL KSRES2(J,J1,J2,RIJ2,TIME)
          KDUM = J1
          K = KDUM
   32     A1 = X(1,K) - XI(1)
          A2 = X(2,K) - XI(2)
...
*
   ...
   35 CONTINUE
*
*     --03/14/14 15:29-lwang-debug--------------------------------------*
***** Note:------------------------------------------------------------**
c$$$      if(i1.eq.1605) then
c$$$         write(125+rank,*)'kspert I1',I1,'IPAIR',ipair,'fp',fp(1),
c$$$     &        'fd',fd(1),'t',time
c$$$         call flush(125+rank)
c$$$      end if
*     --03/14/14 15:29-lwang-end----------------------------------------*
...
***** Note:------------------------------------------------------------**
c$$$      if(i1.eq.1605) then
c$$$         write(125+rank,*)'fchain I1',I1,'IPAIR',ipair,'fp',fp(1),
c$$$     &        'fd',fd(1),'t',time
c$$$         call flush(125+rank)
c$$$      end if
*     --03/14/14 15:29-lwang-end----------------------------------------*
